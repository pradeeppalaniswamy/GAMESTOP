  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="addgames.php">Addgames</a></li>
        <!--<li class="dropdown">
...
<form action="insert_product.php" method="POST" enctype="multipart/form-data">
	...
	<tr><td><label>Choose image: </label></td><td><input type="file" name="image" required="" /></td></tr>
	<tr><td><label>gamename: </label></td><td><input type="text" name="gamename" required=""/></td></tr>
	<tr><td><label>Descrition: </label></td><td><input type="text" name="description" required=""/></td></tr>
	<tr><td><label>Type: </label></td><td><input type="text" name="type"/></td></tr>
	<tr><td><label>Price: </label></td><td><input type="text" name="price" required=""/></td></tr>
	<tr><td><label>Genre: </label></td><td><input type="text" name="genre"/></td></tr>
    <tr><td><input type="submit" class = "btn btn-success"value="addgame" /> </td></tr> 
    <?php?>
</div>	    
